...
fn update(msg: Msg, model: &mut Model, orders: &mut impl Orders<Msg>) {
    match msg {
        Msg::UrlChanged(subs::UrlChanged(url)) => {
            ...
            // model =  Routes::init_state::<State>( previous_state, url ,
...
//             // this party will be a function which the user has full control
// on, could be use for user permission as well             Some(true)
//         } else {
//             None
//         }
//     }
